...
//这里的数据改动过
#define ENCODER_RESOLUTION 1560.0 //编码器分辨率, 轮子转一圈，编码器产生的脉冲数(编码器分辨率：13*30*4（13线，1：30减速比，四倍频）)
#define WHEEL_DIAMETER 0.090 //轮子直径,单位：米
#define D_X 0.183 //底盘Y轴上两轮中心的间距 0.193
#define D_Y 0.213 //底盘X轴上两轮中心的间距 0.169
